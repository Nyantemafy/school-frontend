...
/* Correction pour le contenu avec sidebar */
.content-area {
  width: 100%;
  max-width: 100%;
  overflow-x: hidden;
...
/* Assurez-vous que les containers prennent toute la largeur */
.container-fluid {
  width: 100%;
  padding-right: 15px;
  padding-left: 15px;
...
/* Correction pour les row de Bootstrap */
.row {
  margin-right: -15px;
  margin-left: -15px;
}

/* Correction pour les columns */
